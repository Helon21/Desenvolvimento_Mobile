...
void main(List<String> arguments){
  ...
  */
  var produto,servico,habitantes,pib;
  var densidade, area, populacao;
  print('${Cidade(
    nome: 'Paranavaí',
    estado: Estado(
      nome: 'Paraná',
      sigla: 'PR',
      calcularPIB:(){
        pib = (produto + servico) / habitantes;
        return pib;
      },
    ),
    calcularDensidadeDemografica:() => print(densidade = area / populacao)
  )}');
